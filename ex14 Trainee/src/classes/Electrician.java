...
public class Electrician extends Trainee implements Apprentice {
	...
	public Electrician(String name, LocalDate dateOfBirth, int PPSN, String EmployersName, int phase) {
	...
	public String toString() {
		return "Electrician [EmployersName=" + EmployersName + ", phase=" + phase + ", getName()=" + getName()
